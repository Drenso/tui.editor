...
```
- node_modules/@drenso-toast-ui/editor/dist/
  - i18n/
    - ko-kr.js
    - ...
```
...
```js
import '@drenso-toast-ui/editor/dist/i18n/${fileName}';
```

### CommonJS

```js
require('@drenso-toast-ui/editor/dist/i18n/${fileName}');
```
...
import '@drenso-toast-ui/editor/dist/i18n/ko-kr';
...
Use the `setLanguage` static method to override the value for a specific language code. See [here](https://github.com/Drenso/tui.editor/tree/master/apps/editor/src/i18n/en-us.ts) for default values.
...
Refer to [this file](https://github.com/Drenso/tui.editor/tree/master/src/i18n/en-us.ts) and write each parameter value used when calling the `setLanguage` method.
